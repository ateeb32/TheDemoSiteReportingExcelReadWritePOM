...
import com.qa.ateeb.TheDemoSiteReportingExcelReadWritePOM.Constants;
...
public class ExcelUtils {
	...
	public static void setCellData(String Result, int RowNum, int ColNum, XSSFSheet sheet, XSSFWorkbook workbook) {
